...
const Icon500 = (props: SvgIconProps) => (
  <svg
    className="MuiBox-root css-1wsj86v"
    viewBox="0 0 480 360"
  ...
  >
    ...
    <path
      ...
      opacity={0.2}
    />
    <image href="/assets/illustrations/character-8.webp" height={300} x={340} y={30} />
    <path
      fill="#00A76F"
